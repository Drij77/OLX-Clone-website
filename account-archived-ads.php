            ...
            <ul class="sign-in">
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu">
                  ...
                  <a class="dropdown-item active" href="account-archived-ads.html"><i class="lni-folder"></i> Archived</a>
        ...
        <ul class="mobile-menu">
          ...
          <li>
            ...
            <ul class="dropdown">
              ...
              <li><a class="active" href="account-archived-ads.html"><i class="lni-folder"></i> Archived</a></li>
        ...
        <div class="row">         
          <div class="col-md-12">
            <div class="breadcrumb-wrapper">
              <h2 class="product-title">Archived Ads</h2>
              <ol class="breadcrumb">
                <li><a href="#">Home /</a></li>
                <li class="current">Archived Ads</li>
              </ol>
            </div>
          </div>
        </div>
            ...
            <div class="page-content">
              <div class="inner-box">
                <div class="dashboard-box">
                  <h2 class="dashbord-title">Archived Ads</h2>
                </div>
